...
export async function autocomplete(
    params: z.output<typeof autocompleteQueryParamsSchema>,
    options: Parameters<typeof fetcher>[2]
) {
    const parsedParams = autocompleteQueryParamsSchema.parse(params);

    const url = new URL('/maps/api/place/autocomplete/json', 'https://maps.googleapis.com');
