import { z } from 'zod';
import { streetViewResponseSchema } from './streetViewResponseSchema';

export const streetViewMetadataQueryParamsSchema = z
    .object({
        heading: z
            .number()
            .describe(
 ...
 * @description 200 OK
 */
export const streetViewMetadataQueryResponseSchema = z.lazy(() => streetViewResponseSchema);
