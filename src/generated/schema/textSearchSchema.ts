import { z } from 'zod';
import { placesTextSearchResponseSchema } from './placesTextSearchResponseSchema';

export const textSearchQueryParamsSchema = z.object({
    location: z
        .string()
        .describe(
 ...
 * @description 200 OK
 */
export const textSearchQueryResponseSchema = z.lazy(() => placesTextSearchResponseSchema);
