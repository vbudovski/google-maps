import { z } from 'zod';
import { geocodingResponseSchema } from './geocodingResponseSchema';
import { latLngArrayStringSchema } from './latLngArrayStringSchema';

export const geocodeQueryParamsSchema = z
    .object({
        address: z
            .string()
            .describe(
        ...
        latlng: z
            ...
            .optional(),
        location_type: z
            .array(z.enum(['APPROXIMATE', 'GEOMETRIC_CENTER', 'RANGE_INTERPOLATED', 'ROOFTOP']))
            .describe(
 ...
 * @description 200 OK
 */
export const geocodeQueryResponseSchema = z.lazy(() => geocodingResponseSchema);
