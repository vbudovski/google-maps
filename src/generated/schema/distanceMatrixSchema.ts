import { z } from 'zod';
import { distanceMatrixResponseSchema } from './distanceMatrixResponseSchema';

export const distanceMatrixQueryParamsSchema = z.object({
    arrival_time: z
        .number()
        .describe(
 ...
 * @description 200 OK
 */
export const distanceMatrixQueryResponseSchema = z.lazy(() => distanceMatrixResponseSchema);
