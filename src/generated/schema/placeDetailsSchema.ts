import { z } from 'zod';
import { placesDetailsResponseSchema } from './placesDetailsResponseSchema';

export const placeDetailsQueryParamsSchema = z.object({
    place_id: z
        .string()
        .describe(
 ...
 * @description 200 OK
 */
export const placeDetails200Schema = z.lazy(() => placesDetailsResponseSchema);

/**
 * @description 200 OK
 */
export const placeDetailsQueryResponseSchema = z.lazy(() => placesDetailsResponseSchema);
